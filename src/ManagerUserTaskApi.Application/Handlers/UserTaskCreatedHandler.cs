...
public class UserTaskCreatedHandler : AuditEventHandler<UserTaskCreated, UserTask>
{
    public UserTaskCreatedHandler(IMediatorHandler mediator, IEventStoreRepository eventStoreRepository) : base(mediator,
